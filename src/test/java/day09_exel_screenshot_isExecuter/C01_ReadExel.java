...
public class C01_ReadExel {
   @Test
       ...
       /*   Biz kodlarimizla bilgisayardaki bir dosyaya direk erisim saglayip
         ...
         */
        // 1- bilgisayardaki excel'e ulasabilmek icin dosyaYolu gerekir,content rooth ile aldik
      ...
      System.out.println(cell);
       ...
       System.out.println("***********Ben Yaptim*******************");
        String dosyaYolu1="src/test/java/day09_exel_screenshot_isExecuter/ulkeler (12).xlsx";
        FileInputStream fis1=new FileInputStream(dosyaYolu1);
        Workbook workbook1=WorkbookFactory.create(fis1);
       Cell sayfa11 = workbook1.getSheet("Sayfa1").getRow(11).getCell(3);
       System.out.println(sayfa11);
